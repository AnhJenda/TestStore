...
namespace TestStore.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(TestStoreContext context)
        {
            _context = context;
        }
        ...
        {
            var testStoreContext = _context.Product.Include(p => p.Category);
            return View(await testStoreContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TestStoreContext.Product'  is null.");
            }
            var product = await _context.Product.FindAsync(id);
            if (product != null)
            {
